...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, PSTR szCmdLine, int iCmdShow)
{
	...
	//	Create temporary OpenGL context to get a pointer to wglCreateContextAttribsARB
	...
	//	Delete the temporary context and initialise an OpenGL 4.6 core context.
